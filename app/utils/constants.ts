...
const staticModels: ModelInfo[] = [
  { name: 'llama3.2', label: 'llama3.2', provider: 'Ollama' },
  { name: 'llama3.2:1b', label: 'llama3.2:1b', provider: 'Ollama' },
  { name: 'llama3.1', label: 'llama3.1', provider: 'Ollama' },
  { name: 'gemma2:2b', label: 'gemma2:2b', provider: 'Ollama' },
